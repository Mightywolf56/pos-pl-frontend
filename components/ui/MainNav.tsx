...
export default async function MainNav() {
  ...
  return (
    <header className="px-10 py-5 bg-zinc-800 flex flex-col md:flex-row justify-between ">
      ...
      <Link 
        href={'/admin/sales'}
        className='rounded bg-pink-600 font-bold py-2 px-10 text-white hover:bg-pink-800 text-xl'
      >
