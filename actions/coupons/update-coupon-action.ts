...
import { Coupon, CouponResponseSchema, ErrorResponseSchema } from "@/app/src/schemas";
...
export async function updateCoupon( couponId: Coupon['id'], prevState: ActionStateType, formData: FormData,) {
  const coupon = CouponResponseSchema.safeParse({
  ...
  return {
    errors: [],
    success: "Cupon Actualizado Correctamente",
  };
}
